...
const { values } = parseArgs({
  ...
  options: {
    ...
    engine: { type: 'string', default: 'v16' },
    output: { type: 'string' },
  },
});
...
const version = {
  ...
  v16: {
    ...
    entrySource: `
    export {
      generateAuthorityCohortBaselineV16 as generateAuthorityCohortBaseline,
    } from './src/game/balance/authorityCohortBaselineV16Fixture.ts';
  `,
  },
}[values.engine];

if (!version) throw new Error('--engine must be one of: v15, v16.');

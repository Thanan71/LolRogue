...
async function main() {
  try {
    ...
    for (const raw of entries) {
      ...
      parsed.push({id:raw.id,key:raw.key,name:raw.name,title:raw.title,tags:parseTags(raw.tags),resourceType:raw.partype||'None',stats:parseStats(raw.stats),spells,passive,iconUrl:'lol/data/img/champions/'+raw.image.full});
    }

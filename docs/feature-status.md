...
| Contrat d'équilibrage | `game/balance/contentBalance`, roster et profils biome | `balanceSimulation.test.ts`, `contentBalance.test.ts` | Baseline v15 : contenu v13 conservé, intégrité combat v14 et autorité des cohortes versionnée |

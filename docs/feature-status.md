...
| Contrat d'équilibrage | `game/balance/contentBalance`, roster et profils biome | `balanceSimulation.test.ts`, `contentBalance.test.ts` | Baseline v14 : contenu v13 conservé, intégrité combat et parité bundle verrouillées |

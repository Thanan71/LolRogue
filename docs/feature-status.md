...
| Contrat d'équilibrage | analyse des catalogues/nœuds dans `game/balance/contentBalance`, vraies runs via `simulateAuthorityCohort` et matrice 5v5 exhaustive | `contentCatalogAnalysis.test.ts`, `authorityCohortBaseline.test.ts`, `championCombatMatrix.test.ts`, `dailyProgressionParity.test.ts` | Baseline v19 : dix champions stratifiés, mana/boucliers/CC mesurés, gate P1 0/100 % fermé ; calibration P0 et playtests humains encore ouverts |

  ...
  return (
    <div style={containerStyle}>
      <div style={headerStyle}>
        <span style={{ color: '#eab308', fontWeight: 700, fontSize: 20 }}>
          💎 Treasure
        </span>
          ...
          <>
            ...
            <div style={previewStyle}>
              <div style={previewItemStyle}>
                ...
                <span style={{ color: '#ffd700', fontWeight: 600 }}>+{encounter?.gold ?? 0} Gold</span>
              </div>
              {encounter?.item && (
                <div style={previewItemStyle}>
                  <span style={{ fontSize: 24 }}>📦</span>
...
const previewStyle: React.CSSProperties = {
  ...
  border: '1px solid #eab30844', minWidth: 250, marginBottom: 24,
};
...
const collectBtnStyle: React.CSSProperties = {
  padding: '14px 48px', background: '#eab308', color: '#0d1117',
  border: 'none', borderRadius: 8, fontSize: 18, fontWeight: 700, cursor: 'pointer',
  marginTop: 8,
};

const continueBtnStyle: React.CSSProperties = {
  padding: '14px 48px', background: '#21262d', color: '#c8aa6e',
...
const rewardsContainerStyle: React.CSSProperties = {
  ...
  background: '#161b22', padding: 24, borderRadius: 12,
  border: '1px solid #1e2a3a', width: '100%', maxWidth: 400,
};
...
const rewardLabelStyle: React.CSSProperties = {
  fontSize: 12, color: '#8b949e', textTransform: 'uppercase', letterSpacing: 0.5,
};

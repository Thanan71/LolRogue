...
export const TOP_LANE_ENCOUNTERS: CombatEncounter[] = [
  {
    ...
    type: 'combat',
    enemies: [{ championId: 'Darius', statMultiplier: 0.72 }],
    goldReward: 25,
    itemDropChance: 0.15,
    minRunLevel: 1,
  },
  {
    ...
    type: 'combat',
    enemies: [{ championId: 'Garen', statMultiplier: 0.68 }],
    goldReward: 20,
    itemDropChance: 0.12,
    minRunLevel: 1,
  },
  {
    ...
    type: 'combat',
    enemies: [{ championId: 'Malphite', statMultiplier: 0.76 }],
    goldReward: 30,
    itemDropChance: 0.18,
    minRunLevel: 2,
  },
  {
    ...
    type: 'combat',
    enemies: [{ championId: 'Warwick', statMultiplier: 0.66 }],
    goldReward: 22,
    itemDropChance: 0.14,
    minRunLevel: 1,
  },
  {
    ...
    type: 'combat',
    enemies: [
      { championId: 'Darius', statMultiplier: 0.58 },
      { championId: 'Garen', statMultiplier: 0.58 },
    ],
    goldReward: 45,
    itemDropChance: 0.25,
    minRunLevel: 3,
  },
  {
    ...
    type: 'combat',
    enemies: [
      { championId: 'Malphite', statMultiplier: 0.52 },
      { championId: 'Darius', statMultiplier: 0.6 },
    ],
    goldReward: 48,
    itemDropChance: 0.24,
    minRunLevel: 3,

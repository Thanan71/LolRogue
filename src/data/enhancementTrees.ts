...
function createBranch(
  data: Omit<EnhancementBranch, 'nodes'> & { nodes: EnhancementNode[] },
): EnhancementBranch {
  return data;
}
  ...
  createBranch({
    ...
    nodes: [
      ...
      createNode({
        ...
        name: 'Brûlure',
        description:
          'Les attaques contre vous leur infligent 2% de leurs PV max en dégâts magiques',
        type: 'passive',
        candyCost: 80,
        requiredMasteryLevel: 2,
  ...
  createBranch({
    ...
    nodes: [
      ...
      createNode({
        ...
        name: 'Mort ou Vif',
        description:
          'Ulti: En 1v1 contre un champion, +25% de dégâts et +15% de réduction de dégâts',
        type: 'ultimate',
        candyCost: 150,
        requiredMasteryLevel: 3,

...
const enhancementEffectsFr = {
  ...
  'assassin_burst_3:burst_amplify': 'Dégâts de burst ultimes augmentés',
  ...
  'assassin_mobility_3:stealth_on_kill': 'Invisibilité après un kill',
  ...
  'mage_burst_3:spell_echo': 'Chance de répéter les sorts AoE',
  'mage_control_1:slow': 'Ralentissement sur sorts',
  'mage_control_3:root_chance': "Chance d'enracinement",
  'mage_sustain_2:mana_restore': 'Restauration de mana sur kill',
  'mage_sustain_3:cdr_ultimate': 'Réduction CD ultime',
  ...
  'fighter_bruiser_3:berserker': 'Boost de dégâts quand les PV sont bas',
  ...
  'fighter_duelist_3:duelist': 'Bonus en duel 1v1',
  'fighter_sustain_3:heal_on_kill': 'Soin massif sur kill',
  ...
  'support_tanky_2:cc_extension': 'Durée de CC augmentée',
  ...
  'support_utility_3:cc_aoe': 'Zone de CC augmentée',

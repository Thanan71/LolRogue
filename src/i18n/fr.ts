...
const french = {
  ...
  admin: {
    ...
    killsShort: 'É',
    damageShort: 'D',
    authorityTitle: 'Surveillance authority',
    ...
    authorityAlert: 'Alerte de vérification authority',
    ...
    authorityRejectionsCaption: 'Derniers rejets de vérification authority',
    attempt: 'Tentative',
    engine: 'Moteur',
  ...
  auth: {
    ...
    introTitle: 'Compose ton escouade. Adapte ton build. Survis à chaque détour.',
    introDescription:
